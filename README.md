...
**▶ 웹에서 바로 체험: https://ingon1026.github.io/drawface-live/**
그림을 드래그앤드롭 → 얼굴 자동 인식(실패 시 4클릭) → 웹캠 허용 → 끝.
모든 처리(추적·합성)는 브라우저 안에서만 이뤄지며 영상은 어디로도 전송되지 않습니다.
로컬 개발: `python3 -m http.server 8777 -d docs`
