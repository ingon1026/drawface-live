...
import Delaunator from "./delaunator.js?v=20260729.6";
import { CANVAS } from "./config.js?v=20260729.6";
import { newCanvas, getData, hexToRgb, bboxAlpha } from "./imageops.js?v=20260729.6";
import { composeCharacter } from "./compositor.js?v=20260729.6";
...
const JAW_RAMP = [0.15, 0.45];   // 0.30~0.60 은 과장된 벌림에만 반응 — 말하기 수준(캘리브 ~0.15)부터 열리게
